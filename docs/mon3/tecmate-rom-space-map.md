...
| ---: | --- | ---: | ---: | ---: | ---: |
| 0 | Shell, launcher, registry | `966` | `966` | `83C6h` | `15418` |
...
Expansion occupied bytes: `2787`

Expansion high-water span total: `2787`

Latest shell ABI cleanup delta:
...
| Bank 0 service registry | `839Dh` | Private service ID to bank/address/target-`A` table. |
...
| Bank 0 info marker | `8398h` | Private marker, not a fixed ABI location. |
