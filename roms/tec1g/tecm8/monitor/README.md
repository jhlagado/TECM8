...
`monitor.asm` is the active Debug80 entry source. It contains the MON-3 monitor
body, and the rest of the MON-3 include graph is kept beside it so TECM8 can
edit and debug the monitor locally without changing Debug80's bundled platform
ROM.
