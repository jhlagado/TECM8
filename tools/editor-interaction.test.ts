...
test('editor interaction module exposes a key-stream runner', () => {
  ...
  const inputSource = readRepoFile('src/editor-input.asm');
  ...
  assert.match(inputSource, /^EditorRunKeys:/m);
  assert.match(inputSource, /^EditorRunModifiedKey:/m);
  assert.match(inputSource, /^EditorRunLive:/m);
  assert.match(source, /^EditorKeyLoop:/m);
  ...
  assert.match(renderSource, /^EditorEnsureCursorVisible:/m);
  assert.match(renderSource, /^EditorEnsureCursorVisibleColumn:/m);
  assert.match(renderSource, /^EditorKeyRenderViewport:/m);
  assert.match(cursorSource, /^EditorInvalidateCursorOverlay:/m);
  assert.match(renderSource, /^EditorKeyRenderCursorRowMarkers:/m);
  assert.match(lineEditSource, /^EditorInsertChar:/m);
  assert.match(lineEditSource, /^EditorBackspaceChar:/m);
  assert.match(lineEditSource, /^EditorDeleteChar:/m);
  assert.match(lineEditSource, /^EditorSplitLine:/m);
  assert.match(lineEditSource, /^EditorJoinPreviousLine:/m);
  assert.match(lineEditSource, /^EditorJoinPreviousPageLine:/m);
  ...
  assert.doesNotMatch(source, /TECM8_EDITOR_ACTION_/);
  ...
  assert.doesNotMatch(source, /CALL\s+EditorActionFromKey/);
  assert.match(inputSource, /CALL\s+BiosInputPollKey/);
  assert.match(inputSource, /XOR\s+A\n\s+LD\s+\(EditorKeyStreamModifier\),A\n\s+LD\s+\(EditorInsertMode\),A/);
  assert.match(inputSource, /CALL\s+BiosInputPollKey\n\s+JR\s+NC,EditorLiveIdle\n\s+CALL\s+EditorRunModifiedKey/);
  assert.match(inputSource, /EditorLiveIdle:\n\s+CALL\s+Tecm8DisplayStep\n\s+RET\s+C\n\s+OR\s+A\n\s+JR\s+NZ,EditorLiveIdleDelay\n\s+CALL\s+EditorCursorBlinkStep/);
  assert.match(inputSource, /EditorRunModifiedKey:[\s\S]*?LD\s+\(BiosInputRawPrimary\),A[\s\S]*?EditorRunModifiedKeyClearRawPrimary:[\s\S]*?LD\s+A,0xFF[\s\S]*?LD\s+\(BiosInputRawPrimary\),A[\s\S]*?EditorRunModifiedKeyRawPrimaryReady:[\s\S]*?LD\s+\(EditorLiveKeyBuffer\),A/);
  ...
  assert.match(renderSource, /^EditorKeyRenderCurrentLineCellsDirty:/m);
  assert.match(renderSource, /EditorKeyRenderCurrentLineCellsDirty:[\s\S]*?CALL\s+Tecm8DisplayMarkCellDirty[\s\S]*?CALL\s+Tecm8DisplayMarkCellDirty/);
  assert.match(renderSource, /EditorKeyRenderCursorFlushCurrent:/);
  assert.match(source, /CP\s+TECM8_EDITOR_KEY_ARROW_UP\n\s+JR\s+Z,EditorDispatchArrowUp/);
  assert.match(source, /CP\s+TECM8_EDITOR_KEY_ARROW_DOWN\n\s+JR\s+Z,EditorDispatchArrowDown/);
  assert.match(source, /CP\s+TECM8_EDITOR_KEY_ARROW_LEFT\n\s+JP\s+Z,EditorKeyCursorLeft/);
  assert.match(source, /CP\s+TECM8_EDITOR_KEY_ARROW_RIGHT\n\s+JP\s+Z,EditorKeyCursorRight/);
  ...
  assert.match(source, /EditorDispatchArrowUp:\n\s+LD\s+A,\(EditorPendingModifier\)\n\s+AND\s+TECM8_EDITOR_KEY_MOD_CTRL\n\s+JP\s+NZ,EditorKeyPageUp/);
  assert.match(source, /EditorDispatchArrowDown:\n\s+LD\s+A,\(EditorPendingModifier\)\n\s+AND\s+TECM8_EDITOR_KEY_MOD_CTRL\n\s+JP\s+NZ,EditorKeyPageDown/);
  ...
  assert.doesNotMatch(keymapSource, /EditorActionFromKey/);
  assert.match(cursorSource, /CALL\s+Tecm8DisplayRenderCursorCell/);
  assert.match(cursorSource, /CALL\s+Tecm8DisplayEraseCursorCell/);
  ...
  assert.match(cursorSource, /CALL\s+Tecm8DisplayRenderCursorCell[\s\S]*?LD\s+A,\(EditorCursorVisibleCol\)\n\s+LD\s+\(EditorCursorRenderedCol\),A/);
  assert.match(cursorSource, /EditorInvalidateCursorOverlay:\n\s+XOR\s+A\n\s+LD\s+\(EditorCursorRendered\),A\n\s+RET/);
  assert.match(renderSource, /CALL\s+EditorRenderPageBufferDirtyRows/);
  assert.match(renderSource, /CALL\s+EditorViewportRenderRecordRow/);
  assert.match(renderSource, /CALL\s+EditorViewportRenderRowMarker/);
  assert.match(source, /EditorKeyInsertPrintable:[\s\S]*?JP\s+EditorKeyTailRenderCurrentLineCellsLoop/);
  assert.match(source, /EditorKeyDelete:[\s\S]*?LD\s+A,\(EditorBlockSelectionActive\)[\s\S]*?JP\s+NZ,EditorKeyDeleteBlockPrompt/);
  assert.match(source, /EditorKeyDelete:[\s\S]*?JP\s+EditorKeyTailRenderCurrentLineCellsLoop/);
  assert.match(source, /EditorKeyDeleteBlockPrompt:[\s\S]*?LD\s+HL,EditorDeleteBlockPromptText[\s\S]*?JP\s+EditorKeyTailPromptAskYesNo/);
  ...
  assert.match(blockSource, /^EditorDeleteSelectedBlock:/m);
  assert.match(source, /EditorDeleteBlockPromptText:\n\s+\.db\s+"Delete block\? Y\/N",0/);
  assert.match(source, /EditorKeyBackspaceDirty:\n\s+JP\s+EditorKeyTailRenderCurrentLineCellsLoop/);
  assert.match(source, /EditorKeyBackspaceJoin:[\s\S]*?JP\s+EditorKeyTailRenderDirtyLoop/);
  assert.match(renderSource, /EditorKeyRenderCursorRowMarkers:[\s\S]*?CALL\s+Tecm8DisplayMarkGutterDirty[\s\S]*?CALL\s+Tecm8DisplayMarkGutterDirty/);
  ...
  assert.match(renderSource, /^EditorKeyRenderCursorRowMarkers:/m);
  assert.match(blockSource, /^EditorBlockSelectionBeginIfNeeded:/m);
  assert.match(blockSource, /^EditorBlockSelectionCapturePageAnchor:/m);
  assert.match(blockSource, /^EditorBlockSelectionRestorePageAnchor:/m);
  assert.match(blockSource, /^EditorBlockSelectionUpdateActive:/m);
  assert.match(blockSource, /^EditorBlockSelectionClearState:/m);
  assert.match(blockSource, /^EditorPendingBlockClearState:/m);
  assert.match(blockSource, /^EditorPendingBlockArm:/m);
  assert.match(blockSource, /^EditorBlockStateClearForEdit:/m);
  assert.match(blockSource, /^EditorBlockSelectionClearIfActive:/m);
  assert.match(blockSource, /^EditorBlockSelectionCurrentLine:/m);
  assert.match(renderSource, /JP\s+EditorKeyRenderCursorRowMarkers/);
  ...
  assert.match(keymapSource, /^EditorModifiedCommandTable:/m);
  assert.match(keymapSource, /^EditorModifiedCommandLookup:/m);
  assert.match(keymapSource, /EditorModifiedCommandTable:[\s\S]*?\.db\s+"s",TECM8_EDITOR_KEY_SAVE/);
  assert.doesNotMatch(keymapSource, /EditorModifiedCommandAltQuit/);
  assert.match(keymapSource, /EditorModifiedCommandTable:[\s\S]*?\.db\s+"c","C"/);
  assert.match(keymapSource, /EditorModifiedCommandTable:[\s\S]*?\.db\s+"x","X"/);
  assert.match(keymapSource, /EditorModifiedCommandTable:[\s\S]*?\.db\s+"v","V"/);
  assert.match(keymapSource, /EditorModifiedCommandTable:[\s\S]*?\.db\s+"y","Y"/);
  assert.doesNotMatch(keymapSource, /CP\s+"[SQZCXVY]"\n\s+JR\s+Z,EditorModifiedCommand/);
  ...
  assert.match(keymapSource, /EditorModifiedCommandTable:[\s\S]*?\.db\s+TECM8_EDITOR_KEY_CTRL_X,"X"/);
  assert.match(keymapSource, /EditorModifiedCommandTable:[\s\S]*?\.db\s+TECM8_EDITOR_KEY_CTRL_V,"V"/);
  assert.match(keymapSource, /EditorModifiedCommandTable:[\s\S]*?\.db\s+TECM8_EDITOR_KEY_CTRL_Y,"Y"/);
  assert.match(keymapSource, /EditorModifiedCommandTable:[\s\S]*?\.db\s+"q",TECM8_EDITOR_KEY_QUIT/);
  assert.match(keymapSource, /EditorModifiedCommandTable:[\s\S]*?\.db\s+"z",TECM8_EDITOR_KEY_RESTORE/);
  ...
  assert.match(source, /EditorKeyCopyBlock:[\s\S]*?CALL\s+EditorPendingBlockArm\n\s+RET\s+C\n\s+JP\s+EditorKeyTailRenderMarkersLoop/);
  assert.match(source, /EditorKeyMoveBlock:[\s\S]*?CALL\s+EditorPendingBlockArm\n\s+RET\s+C\n\s+JP\s+EditorKeyTailRenderMarkersLoop/);
  assert.match(source, /EditorKeyPasteBlock:[\s\S]*?CALL\s+EditorPendingBlockPasteInsert[\s\S]*?JP\s+EditorKeyTailRenderDirtyLoop/);
  assert.match(source, /EditorKeyTailPromptAskYesNo:/);
  assert.match(source, /EditorKeyTailRenderDirtyLoop:/);
  assert.match(source, /EditorKeyTailRenderCurrentLineCellsLoop:/);
  assert.match(source, /EditorKeyTailRenderCursorColumnLoop:/);
  assert.match(source, /EditorKeyTailRenderCursorMoveLoop:/);
  assert.match(source, /EditorKeyTailRenderCursorMoveMarkersLoop:/);
  assert.match(source, /EditorKeyTailRenderMarkersLoop:/);
  assert.match(source, /EditorKeyTailRestoreStatusRowLoop:/);
  assert.match(source, /EditorKeyTailSelectPageLoop:/);
  assert.match(source, /EditorKeyRestorePrompt:[\s\S]*?JP\s+EditorKeyTailPromptAskYesNo/);
  assert.match(source, /EditorKeySplitLine:[\s\S]*?JP\s+EditorKeyTailRenderDirtyLoop/);
  assert.match(source, /EditorKeyInsertPrintable:[\s\S]*?JP\s+EditorKeyTailRenderCurrentLineCellsLoop/);
  assert.match(source, /EditorKeyCursorLeft:[\s\S]*?JP\s+EditorKeyTailRenderCursorColumnLoop/);
  assert.match(source, /EditorKeyCursorDown:[\s\S]*?JP\s+EditorKeyTailRenderCursorMoveLoop/);
  assert.match(source, /EditorKeySelectDown:[\s\S]*?JP\s+EditorKeyTailRenderCursorMoveMarkersLoop/);
  assert.match(source, /EditorKeyCopyBlock:[\s\S]*?JP\s+EditorKeyTailRenderMarkersLoop/);
  assert.match(source, /EditorKeyPageDownEnd:[\s\S]*?JP\s+EditorKeyTailRestoreStatusRowLoop/);
  assert.match(source, /EditorKeySelectPageDown:[\s\S]*?JP\s+EditorKeyTailSelectPageLoop/);
  assert.match(blockSource, /^EditorPendingBlockPasteInsert:/m);
  assert.match(blockSource, /^EditorPendingBlockCopySourceToScratch:/m);
  assert.match(blockSource, /^EditorPendingBlockShiftRowsDown:/m);
  assert.match(blockSource, /^EditorPendingBlockDeleteMovedSource:/m);
  assert.match(blockSource, /^EditorPendingBlockPasteReplace:/m);
  assert.match(blockSource, /^EditorPendingBlockDestinationRowsForCurrentPage:/m);
  assert.match(blockSource, /^EditorPendingBlockRejectReplaceOverlap:/m);
  assert.match(blockSource, /^EditorPendingBlockDeleteOriginalSource:/m);
  assert.match(blockSource, /^EditorPendingBlockSelectInsertedRows:/m);
  ...
  assert.match(inputSource, /EditorInsertMode:\n\s+\.db\s+0/);
  assert.match(inputSource, /EditorLiveKeyBuffer:\n\s+\.db\s+0,0/);
  assert.match(inputSource, /EditorKeyStreamModifier:\n\s+\.db\s+0/);
  assert.match(inputSource, /EditorPendingModifier:\n\s+\.db\s+0/);
  assert.match(source, /EditorKeyInsertMode:/);
  assert.match(source, /EditorKeyPrompt:/);
  assert.match(source, /EditorKeyEditDispatch:/);
  assert.doesNotMatch(source, /EditorKeyMaybeInsertMode:/);
  assert.match(source, /LD\s+A,\(EditorInsertMode\)\n\s+OR\s+A\n\s+JR\s+NZ,EditorKeyEditDispatch/);
  assert.match(source, /CP\s+TECM8_EDITOR_KEY_ARROW_RIGHT\n\s+JP\s+Z,EditorKeyCursorRight\n\nEditorKeyEditDispatch:/);
  assert.equal((source.match(/CALL\s+EditorShouldIgnoreModifiedPrintable/g) ?? []).length, 1);
  assert.match(source, /EditorKeyQuit:/);
  assert.match(source, /EditorKeyRestorePrompt:/);
  assert.match(inputSource, /EditorQuitRequested:\n\s+\.db\s+0/);
  ...
  assert.match(source, /EditorKeyCursorDown:[\s\S]*?JP\s+EditorKeyTailRenderCursorMoveLoop/);
  assert.match(source, /EditorKeyCursorUp:[\s\S]*?JP\s+EditorKeyTailRenderCursorMoveLoop/);
  ...
  assert.match(source, /EditorKeyPageDownEnd:\n\s+JP\s+EditorKeyTailRestoreStatusRowLoop/);
  ...
  assert.match(renderSource, /EditorEnsureCursorVisible:[\s\S]*?LD\s+A,\(EditorNavViewportTopRow\)[\s\S]*?EditorEnsureCursorScrollDown:/);
  assert.match(renderSource, /EditorKeyRenderCursorMove:[\s\S]*?CALL\s+EditorEnsureCursorVisible[\s\S]*?JP\s+NZ,EditorKeyRenderViewport/);
  assert.match(source, /EditorKeyTailPageMoveLoop:\n\s+CALL\s+EditorCursorResetState\n\s+CALL\s+EditorInvalidateCursorOverlay/);
  ...
  assert.match(source, /EditorKeySelectPageDown:[\s\S]*?CALL\s+EditorBlockSelectionCapturePageAnchor[\s\S]*?JP\s+EditorKeyTailSelectPageLoop/);
  assert.match(source, /EditorKeySelectPageUp:[\s\S]*?CALL\s+EditorBlockSelectionCapturePageAnchor[\s\S]*?JP\s+EditorKeyTailSelectPageLoop/);
  assert.match(renderSource, /EditorKeyRenderViewport:\n\s+CALL\s+EditorRenderPageBufferDirtyRows/);
  assert.match(source, /EditorKeyCursorRight:/);
  assert.match(source, /EditorKeyCursorLeft:[\s\S]*?JP\s+EditorKeyTailRenderCursorColumnLoop/);
  assert.match(source, /EditorKeyCursorRight:[\s\S]*?JP\s+EditorKeyTailRenderCursorColumnLoop/);
  assert.match(renderSource, /EditorEnsureCursorVisibleColumn:[\s\S]*?LD\s+A,\(EditorViewportColOffset\)[\s\S]*?EditorEnsureCursorColumnScrollRight:/);
  assert.match(renderSource, /EditorKeyRenderCursorColumnMove:[\s\S]*?CALL\s+EditorEnsureCursorVisibleColumn[\s\S]*?JP\s+NZ,EditorKeyRenderViewport/);
  ...
  assert.match(lineEditSource, /JP\s+Z,EditorJoinPreviousLine/);
  ...
  assert.match(lineEditSource, /CALL\s+Tecm8RecordShiftTextRight/);
  assert.match(lineEditSource, /CALL\s+Tecm8RecordShiftTextLeft/);
  assert.match(lineEditSource, /CALL\s+Tecm8RecordShiftRecordsDown/);
  assert.match(lineEditSource, /CALL\s+Tecm8RecordShiftRecordsUp/);
  ...
  assert.match(lineEditSource, /EditorSplitPushLastRecordToNextPage:/);
  assert.match(lineEditSource, /EditorSplitFinalRow:/);
  assert.match(lineEditSource, /CALL\s+EditorNavRememberCurrentPage/);
  assert.match(lineEditSource, /CALL\s+EditorNavSlideNextPageToCurrent/);
  assert.match(lineEditSource, /EditorNavNextPageBuffer/);
  ...
  assert.match(lineEditSource, /EditorJoinPreviousLine:\n\s+LD\s+A,\(EditorCursorCol\)\n\s+OR\s+A\n\s+JP\s+NZ,EditorJoinDone/);
  assert.doesNotMatch(source, /EditorSplitShiftLoop:/);
  assert.doesNotMatch(source, /EditorJoinShiftLoop:/);
  assert.doesNotMatch(blockSource, /EditorPendingBlockShiftLoop:/);
  assert.doesNotMatch(blockSource, /EditorPendingBlockScratchLoop:/);
  assert.doesNotMatch(blockSource, /EditorPendingBlockCopyDestLoop:/);
  assert.doesNotMatch(blockSource, /EditorPendingBlockDeleteLoop:/);
...
test('editor dirty render proof covers ordinary movement and printable edit paths', () => {
  ...
  assert.match(proof, /ScrollKeys:/);
  assert.match(proof, /ScrollScreenCount:/);
  assert.match(proof, /ScrollPageCount:/);
  assert.match(proof, /ScrollFullFlushCount:/);
  assert.match(proof, /ScrollRowFlushCount:/);
  assert.match(proof, /ScrollStepCount:/);
  assert.match(proof, /ScrollCoalesceKeys:/);
  assert.match(proof, /ScrollCoalesceFullFlushCount:/);
  assert.match(proof, /ScrollCoalesceStepCount:/);
  assert.match(proof, /ResidentBoundaryKeys:/);
  assert.match(proof, /ResidentBoundaryFullFlushCount:/);
  assert.match(proof, /ResidentBoundaryStepCount:/);
  assert.match(proof, /ResidentBoundaryUpKeys:/);
  assert.match(proof, /ResidentBoundaryUpFullFlushCount:/);
  assert.match(proof, /ResidentBoundaryUpStepCount:/);
  ...
  assert.match(runner, /ScrollFullFlushCount/);
  assert.match(runner, /ScrollRowFlushCount/);
  assert.match(runner, /ScrollStepCount/);
  assert.match(runner, /ScrollCoalesceFullFlushCount/);
  assert.match(runner, /ScrollCoalesceStepCount/);
  assert.match(runner, /ResidentBoundaryFullFlushCount/);
  assert.match(runner, /ResidentBoundaryStepCount/);
  assert.match(runner, /ResidentBoundaryUpFullFlushCount/);
  assert.match(runner, /ResidentBoundaryUpStepCount/);
