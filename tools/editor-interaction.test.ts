...
test('editor interaction module exposes a key-stream runner', () => {
  ...
  assert.match(source, /EditorKeyPageDown:[\s\S]*?CALL\s+EditorPageDown[\s\S]*?CALL\s+EditorCursorResetState\n/);
  assert.match(source, /EditorKeyPageUp:[\s\S]*?CALL\s+EditorPageUp[\s\S]*?CALL\s+EditorCursorResetState\n/);
