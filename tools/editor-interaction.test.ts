...
test('editor interaction module exposes a key-stream runner', () => {
  ...
  assert.match(renderSource, /@EditorKeyRenderCurrentLineCellsDirty:[\s\S]*?CALL\s+GlcdTileMarkCellDirty[\s\S]*?CALL\s+GlcdTileMarkCellDirty/);
  ...
  assert.match(renderSource, /@EditorKeyRenderCursorRowMarkers:[\s\S]*?CALL\s+GlcdTileMarkGutterDirty[\s\S]*?CALL\s+GlcdTileMarkGutterDirty/);
